...
class RestUrlFormationExceptionTest {

	@Test
	void bizcompServiceExceptionTestCases() throws Exception {
		RestUrlFormationException bizcompServiceException = new RestUrlFormationException("Unexpected URL",
				"The url localhost:/ is not found: connection refused", HttpStatus.NOT_FOUND);
		assertThat(bizcompServiceException.getDetails())
				.isEqualTo("The url localhost:/ is not found: connection refused");
